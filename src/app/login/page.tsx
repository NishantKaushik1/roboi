        ...
        <div className="flex h-full w-full font-barlow">
            ...
            >
                ...
                <div className="mb-[5px] text-center">
                    <h1 className="font-bold text-[40px] leading-[120%] text-white tracking-normal font-barlow">
                        ROBO-i
                    </h1>
                ...
                <div className="w-full max-w-[480px] bg-white rounded-[24px] p-10 shadow-2xl animate-fade-in relative z-10">
                    <div className="flex justify-center mb-6">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-xl font-bold text-[#1C2347]">NAYARA</span>
                            <span className="text-xs text-gray-500 mt-1">ENERGY</span>
                        </div>
                    </div>

                    <div className="mb-[5px]">
                        <h2 className="font-bold text-[28px] text-[#1C2347] mb-1">Sign In</h2>
                        <p className="text-sm text-gray-500">Sign in admin Portal</p>
                    </div>
                ...
                {/* Bottom Stats */}
                <div className="absolute bottom-10 left-0 right-0 flex justify-center gap-12 text-white/90">
                    <div className="flex flex-col items-center gap-2">
                        ...
                        <span className="text-[10px] font-medium text-center leading-tight">Audit-ready<br />reports</span>
                    </div>
                    <div className="flex flex-col items-center gap-2">
                        <div className="h-8 w-8 rounded bg-white/10 flex items-center justify-center backdrop-blur-sm">
                            <HiShieldCheck className="h-5 w-5" />
                        </div>
                        <span className="text-[10px] font-medium text-center leading-tight">Secure cloud<br />infrastructure</span>
                    </div>
                    <div className="flex flex-col items-center gap-2">
                        <div className="h-8 w-8 rounded bg-white/10 flex items-center justify-center backdrop-blur-sm">
                        ...
                        <span className="text-[10px] font-medium text-center leading-tight">Actionable alerts<br />& insights</span>
                    </div>
                </div>
            </div>
            ...
            <div className="hidden lg:flex w-1/2 bg-[#001233] relative overflow-hidden flex-col items-center justify-center text-center p-12">
                ...
                <div className="relative z-10 max-w-md">
                    <h2 className="font-bold text-[40px] leading-[120%] text-white font-barlow mb-4">
                        ROBO-I Ever Watchful AI
                    </h2>
                    <p className="font-medium text-[20px] leading-[136%] tracking-[-0.01em] text-white/80 font-barlow">
