        ...
        <div className="flex h-full w-full font-barlow">
            ...
            <div className="relative flex w-full lg:w-1/2 flex-col items-center justify-center p-8">
                ...
                <div className="absolute inset-0 z-0">
                    <Image
                        src="/assets/login/gradientleft.png"
                        alt="Background"
                        fill
                        priority
            ...
            <div className="hidden lg:flex w-1/2 bg-[#001233] relative overflow-hidden flex-col items-center justify-center text-center p-12">
                ...
                <div className="relative w-full max-w-lg aspect-square mb-12">
                    <div className="absolute top-0 right-[-70px] w-3/4 h-3/4 rounded-2xl overflow-hidden border-4 border-white/10 shadow-2xl z-10 bg-black">
                    ...
                    <div className="absolute bottom-0 left-[-70px] w-3/4 h-3/4 rounded-2xl overflow-hidden border-4 border-white/10 shadow-2xl z-[9999] bg-black">
