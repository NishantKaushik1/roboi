    ...
    return (
        <div className="flex h-full flex-col gap-6 p-6">
            ...
            <div className="flex flex-col gap-1">
                ...
                <h1 className="text-xl font-bold text-gray-900 dark:text-white capitalize">{stateName}- ROs</h1>
            </div>
                        ...
                        <div className="w-1/2 max-md:w-full flex flex-col p-4 border-r border-gray-100 dark:border-gray-800">
                            <div className="mb-4">
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="font-bold text-gray-900 dark:text-white capitalize">{stateName}</span>
                                </div>
                                <div className="text-2xl font-bold text-gray-900 dark:text-white mt-1">2087 <span className="text-xs font-normal text-gray-500">ROs</span></div>
                            </div>
