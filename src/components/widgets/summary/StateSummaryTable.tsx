...
export default function StateSummaryTable({ data }) {
    return (
        <div className="w-full overflow-hidden rounded-lg bg-white shadow-sm ring-1 ring-gray-200 dark:bg-gray-900 dark:ring-gray-800">
            ...
            <div className="divide-y divide-gray-200 dark:divide-gray-800 font-barlow">
                {data.map((row, index) => (
                    <div key={index} className="flex items-center px-6 py-4 hover:bg-gray-50 dark:hover:bg-gray-800/50">
                        <div className="w-1/4 text-sm font-medium text-gray-900 dark:text-white">{row.state}</div>
