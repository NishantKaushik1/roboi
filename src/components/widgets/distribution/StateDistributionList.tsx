...
export default function StateDistributionList({ data, className }) {
                    ...
                    {filteredData.map((item, index) => (
                        ...
                        >
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <button className="rounded-full border border-blue-200 px-3 py-1 text-[10px] font-medium text-blue-600 hover:bg-blue-50 dark:border-blue-900 dark:text-blue-400">
                                    Open
                                </button>
                            </div>
                        </div>
